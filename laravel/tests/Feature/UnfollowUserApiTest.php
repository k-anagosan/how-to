...
class UnfollowUserApiTest extends TestCase
{
    use RefreshDatabase,
        WithFaker;
    ...
    {
        $response = $this->actingAs($this->user)->deleteJson(route('user.unfollow', $this->followId));
    ...
    {
        $response = $this->deleteJson(route('user.unfollow', $this->followId));
    ...
    {
        $this->actingAs($this->user)->deleteJson(route('user.unfollow', $this->followId));
        $this->actingAs($this->user)->deleteJson(route('user.unfollow', $this->followId));
        $this->actingAs($this->user)->deleteJson(route('user.unfollow', $this->followId));
    ...
    {
        $response = $this->actingAs($this->user)->deleteJson(route('user.unfollow', $this->user->id));
    ...
    {
        $response = $this->actingAs($this->user)->deleteJson(route('user.unfollow', self::USER_NUMBER + 1));
